...
class Main:
    def __init__(self, root):
        ...
        #-------Background Image-------#
        # Add image file
        # image2 = Image.open('Aug.jpg')
        # image1 = ImageTk.PhotoImage(image2)

        # Show image using label
        # label1 = Label(self.root, image=image1, justify=CENTER)
        # label1.pack()

        # ---Create Label----#
        title = Label(text="-AugEngineer-", font=("Calibri", 45, "bold"), bg="blue", fg="yellow", padx=10)
        title.place(x=420, y=30)

        w = Label(root, text="Welcome to AugEngineer!!\nTransforming the Future Engineers", font=("Comic Sans MS", 20, "bold"), fg='white', bg='black')
        w.place(x=385, y=200)

        #-----Exit Message----#
        e = Label(root, text="Message for Exit the Window: press 'ESC Button' and close the window",
                  font=("Calibri", 15, "bold"), fg='red', bg='black')
        e.place(x=300, y=660)

        # ----Mechanical branch button----#
        btn1 = Button(self.root, command=self.Mechanical, text="Mechanical Stream", bg="#154e7d", fg="white",
                     font=("Calibri", 20))
        btn1.place(x=190, y=370, width=300, height=60)

        # ----Civil branch button----#
        btn2 = Button(self.root, command=self.Civil, text="Civil Stream", bg="#154e7d", fg="white", font=("Calibri", 20))
        btn2.place(x=700, y=370, width=300, height=60)

        # ----Computer science branch button----#
        btn3 = Button(self.root, command=self.Computer, text="Computer Science Stream", bg="#154e7d", fg="white",
                     font=("Calibri", 20))
        btn3.place(x=190, y=500, width=300, height=60)

        # ----EC branch button----#
        btn4 = Button(self.root, command=self.Electrical, text="Electrical Stream", bg="#154e7d", fg="white",
                     font=("Calibri", 20))
        btn4.place(x=700, y=500, width=300, height=60)

    # ----When Mechanical button is clicked this function will run---#
    def Mechanical(self):
        # Getting Information form the Input image
        input_image = cv2.imread('dc-read.png')
        augment_image = cv2.imread('dc-aug.png')
        ...
        while (ret):
            ...
            if (matches != None):
                if (len(matches) > 10):
                    ...
                    # getting the frame ready for addition operation for Mechanical Image
    ...
    def Civil(self):
        # Getting Information form the Input image
        input_image = cv2.imread('civil-read.png')
        augment_image = cv2.imread('civil-aug.png')
    ...
    def Computer(self):
        # Getting Information form the Input image
        input_image = cv2.imread('osi-read.png')
        augment_image = cv2.imread('osi-aug.png')
    ...
    def Electrical(self):
        # Getting Information form the Input image
        input_image = cv2.imread('electrical-read.png')
        augment_image = cv2.imread('electrical-aug.png')
